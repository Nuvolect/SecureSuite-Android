...
public class LogUtil {
    ...
    public enum LogType { NIL,
        ...
        WORKER, FILE_OBJ, OMNI_FILES, OMNI_IMAGE, OMNI_ZIP, MIME_UTIL, CMD_ZIPDL, CMD_UPLOAD, CMD_TREE, SIZE, CMD_SEARCH, CMD_RESIZE, CMD_RENAME, CMD_PUT, CMD_OPEN, CMD_DUPLICATE, CMD_EXTRACT, CMD_FILE, CMD_GET, CMD_IMAGE_QUERY, CMD_INFO, INFO, CMD_PARENTS, CMD_PASTE, CMD_MKDIR, CMD_MKFILE, CMD_LS, OMNI_FILE, CMD_LOGIN,
        }
