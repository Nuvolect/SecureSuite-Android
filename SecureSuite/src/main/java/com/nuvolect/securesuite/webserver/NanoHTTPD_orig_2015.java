...
public abstract class NanoHTTPD_orig_2015 {
    /**
     ...
     */
    public NanoHTTPD_orig_2015(int port) {
        this(null, port);
    }
     ...
     */
    public NanoHTTPD_orig_2015(String hostname, int port) {
    ...
    public static SSLServerSocketFactory makeSSLSocketFactory(String keyAndTrustStoreClasspathPath, char[] passphrase) throws IOException {
        ...
        try {
            ...
            InputStream keystoreStream = NanoHTTPD_orig_2015.class.getResourceAsStream(keyAndTrustStoreClasspathPath);
