...
public abstract class NanoHTTPD_2015 {
    /**
     ...
     */
    public NanoHTTPD_2015(int port) {
        this(null, port);
    }
     ...
     */
    public NanoHTTPD_2015(String hostname, int port) {
...
//            KeyStore keystore = KeyStore.getInstance(KeyStore.getDefaultType());
            ...
            InputStream keystoreStream = NanoHTTPD_2015.class.getResourceAsStream(keyAndTrustStoreClasspathPath);
    ...
    public static SSLServerSocketFactory makeSSLSocketFactory(KeyStore loadedKeyStore, KeyManagerFactory loadedKeyFactory) throws IOException {
        ...
        try {
            ...
            SSLContext ctx = SSLContext.getInstance("TLS");
            LogUtil.log(LogUtil.LogType.NANOHTTPD, "Default protocol: " + ctx.getProtocol());
...
//            ss.setEnabledCipherSuites(new String[]{"TLS_RSA_WITH_AES_128_GCM_SHA256"});
        ...
        myServerSocket.bind((hostname != null) ?
                new InetSocketAddress(hostname, myPort) : new InetSocketAddress(myPort));
            ...
            public void run() {
                do {
                    try {
                        ...
                        LogUtil.log(LogUtil.LogType.NANOHTTPD, "Exception: "+e.toString());
                    }
