...
public abstract class NanoHTTPD_orig {
    /**
     ...
     */
    public NanoHTTPD_orig(int port) {
        this(null, port);
    }
     ...
     */
    public NanoHTTPD_orig(String hostname, int port) {
    ...
    public static SSLServerSocketFactory makeSSLSocketFactory(String keyAndTrustStoreClasspathPath, char[] passphrase) throws IOException {
        ...
        try {
            ...
            InputStream keystoreStream = NanoHTTPD_orig.class.getResourceAsStream(keyAndTrustStoreClasspathPath);
